...
// Opsi B — Pisah URL: Super Admin vs Admin Wilayah
// Dev: /super-admin (Super Admin) + /admin (Admin Wilayah) ; Prod: env obfuscated
// Super Admin — Makassar, unscoped (region_id null) — http://127.0.0.1:8000/super-admin/login
...
// Admin Wilayah — per Kabupaten/Kota, scoped own region (region_id FK) — http://127.0.0.1:8000/admin/login
...
// Legacy alias /wilayah → backward compat (deprecated, maps to admin wilayah)
