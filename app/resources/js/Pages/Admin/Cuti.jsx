...
export default function CutiAdmin() {
    ...
    const filtered = useMemo(() => initial.filter((c) => {
        ...
        <AdminLayout>
            <div className="space-y-5">
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                    <div>
                        <h1 className="text-xl font-semibold tracking-tight text-[#0F172A]">Cuti — Berjenjang</h1>
                        <p className="text-sm text-[#64748B]">Atasan → Admin Wilayah → Kantor Pusat • 3 level, reject terminal • Approval sesuai level & wilayah</p>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_16px_rgba(15,23,42,0.04)] overflow-hidden">
                    ...
                    <div className="px-4 py-3 bg-[#F8FAFC] text-xs text-[#64748B] flex flex-wrap gap-2 justify-between">
                        <span>Super Admin approve semua level • Admin Wilayah approve own region level sesuai kewenangan</span>
