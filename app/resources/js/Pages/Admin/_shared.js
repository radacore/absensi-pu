...
export const DUMMY_LOVE = [
    { id: 1, employee_id: 1, nama: 'Andi Saputra', wilayah: 'Kab. Gowa', kantor: 'Kantor Gowa', office_location_id: 201, jam: '07:52', jarak: 42, radius: 200, alasan: 'Macet poros Gowa — perbaikan jalan', status: 'pending', createdAt: '2026-08-24T07:52:00+08:00' },
    { id: 2, employee_id: 4, nama: 'Rina Wati', wilayah: 'Kab. Gowa', kantor: 'Kantor Gowa', office_location_id: 201, jam: '07:48', jarak: 28, radius: 200, alasan: 'Antar anak sakit', status: 'pending', createdAt: '2026-08-24T07:48:00+08:00' },
    { id: 3, employee_id: 99, nama: 'Rudi Hartono', wilayah: 'Kab. Bone', kantor: 'Kantor Bone', office_location_id: 401, jam: '07:55', jarak: 18, radius: 150, alasan: 'Ban bocor', status: 'approved', createdAt: '2026-08-23T07:55:00+08:00' },
    { id: 4, employee_id: 5, nama: 'Dewi Lestari', wilayah: 'Kab. Takalar', kantor: 'Kantor Takalar', office_location_id: 2001, jam: '08:05', jarak: 95, radius: 200, alasan: 'Hujan deras', status: 'rejected', note: 'Alasan tidak cukup kuat', createdAt: '2026-08-22T08:05:00+08:00' },
    { id: 5, employee_id: 3, nama: 'Budi Santoso', wilayah: 'Kab. Gowa', kantor: 'Kantor Gowa', office_location_id: 202, jam: '07:44', jarak: 21, radius: 150, alasan: 'Keterlambatan KRL', status: 'pending', createdAt: '2026-08-24T07:44:00+08:00' },
];
